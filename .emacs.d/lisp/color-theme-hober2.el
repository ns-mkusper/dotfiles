  ...
  (color-theme-install
   `(color-theme-hober2
     ...
     (mode-line-highlight ((t (:foreground "black" :background "light sky blue"
                               :inverse-video nil :box ))))
     (modeline-buffer-id ((t (:foreground "white" :background "dodger blue" :inverse-video nil :box))))
     (mode-line-buffer-id ((t (:foreground "white" :background "dodger blue" :inverse-video nil :box))))
     ...
     (speedbar-button-face ((t (:foreground "medium sea green" :background "cadet blue"))))
